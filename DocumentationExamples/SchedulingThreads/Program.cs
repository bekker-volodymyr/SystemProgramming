namespace SchedulingThreads
{
    public class Program
    {
        public static void RunMultipleThreadsOnDifferentPriorities()
        {
        ...
        public static void Callback(ThreadPriority threadPriority)
        {
        ...
        {
            RunMultipleThreadsOnDifferentPriorities();
        }
    }
}
...
//      Callback in BelowNormal priority. 